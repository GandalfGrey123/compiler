...
public class SourceReader {
    ...
    private ArrayList <String> sourceLineData = new ArrayList<String>();
    ...
    public char read() throws IOException {
        ...
        if (isPriorEndLine) {
            ...
            if (nextLine != null) {
                ...
                sourceLine = lineno + ". " + nextLine;
                sourceLineData.add(sourceLine);
            }
...
*/
    ...
    public void printSource() {
       System.out.println("\n \n " ); 
      for (String s : sourceLineData) { System.out.println(s); }
    }
