...
*/
    public Token newIntToken(String number,int startPosition,int endPosition) {
...
*/
    public Token makeToken(String s,int startPosition,int endPosition) {
        ...
        if (sym == null) {
             System.out.println("******** illegal character: '" + s +  "' on line: " + source.getLineno());
             atEOF = true;
             return nextToken();
        }
...
**/
    ...
    public Token nextToken() { // ch is always the next char to process
        ...
        /*
        * number tokens ints and numbers lines
        * these two if blocks handle two different cases for floats
        * case 1 for floats (if int or if float that begins with number)
        * case 2 for floats (starts with decimal, or is illegal decimal)
        */
        //case 1
        if (Character.isDigit(ch)) {
            ...
            try {
                       ...
                       return newIntToken(number,startPosition,endPosition);
