...
public class RunTimeStack {
    ...
    public int getAtValue(int offset){
        int itemRunStackPosition = (framePointer.peek()+offset);
        return runStack.get(itemRunStackPosition);
    }
    ...
    public void popFrame() {
        ...
        //from the beginning of the frame to the end is levelsToPop
        int levelsToPop = runStack.size()-frameStart;
        
        //save return value
        int returnValue = runStack.get(runStack.size()-1);
        
        //pop levelsTopPop amount of times
    ...
    public void dumpStack() {
        ...
        //else has more than one frame
            ...
            for(int currentItem = 0; currentItem < frameEnd-1; currentItem++){
