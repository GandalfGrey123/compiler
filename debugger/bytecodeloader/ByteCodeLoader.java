...
//iterates through source file
//capture OpCode and arguements
//resolve labels and saves the address in hashmap
//send hashmap to program object to be resolve branch code address
public class ByteCodeLoader {
    ...
    public Program loadCodes() {
        try {
            ...
            System.out.println("*** Error reading bytes code" + e);
        }
