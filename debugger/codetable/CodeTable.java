...
public class CodeTable {
   ...
   private static java.util.HashMap<String,String> opCodes = new java.util.HashMap<String,String>(); 
    ...
    public static void init(){    
        ...
        opCodes.put("LINE", "LineCode");
        opCodes.put("FUNCTION", "FunctionCode");
        opCodes.put("FORMAL", "FormalCode");
    }
    ...
    public static void initDebugCodes(){
        ...
        //debugger codes
            opCodes.put("CALL","DBCallCode" );
            opCodes.put("POP", "DBPopCode");
            opCodes.put("LIT","DBLitCode" );
            opCodes.put("RETURN","DBReturnCode" );
    }
}
